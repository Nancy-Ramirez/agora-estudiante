        ...
        <div>
            ...
            <div class="px-4 pt-6 ">
                ...
                <div class="grid gap-4 xl:grid-cols-2 2xl:grid-cols-3 mx-15">
                    {/*-- Main widget --*/}
                    <div class="p-4 bg-white border border-cyan-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-cyan-700 sm:p-6 dark:bg-gray-600">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-shrink-0">
                                <span class="text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white">Materias</span>
                                <h3 class="text-base font-light text-gray-500 dark:text-gray-400">materias inscritas</h3>
                            </div>
